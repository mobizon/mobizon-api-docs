...
`params[shortenLinks]` | integer | SMS мәтініндегі барлық сілтемелерге қысқарту функциясын қолдану қажеттілігін көрсететін жалауша. Әдепкі бойынша: 0 (өшірілген). Қосу үшін **1** мәніне орнатыңыз.
