...
`params[shortenLinks]` | integer | Флаг, указывающий на необходимость применить функцию сокращения ко всем ссылкам в тексте SMS. По умолчанию: 0 (отключено). Установите в **1**, чтобы включить.
