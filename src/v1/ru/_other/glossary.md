...
К подписям отправителя существует [ряд требований](/ru/help/sender-id/sender-id).
...
Статистические данные предоставляются в удобной форме: можно увидеть количество кликов за последние 2 часа, день, неделю, 30 дней или все время (детальнее см. в разделе [короткие ссылки](/ru/help/url-shortener/how-to-shorten-url)).
...
Подробнее о создании Форм вы можете узнать в разделе [“Формы”](/ru/help/forms/how-to-create-form).
