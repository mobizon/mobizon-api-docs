...
К подписям отправителя существует [ряд требований](sender-id).
...
Статистические данные предоставляются в удобной форме: можно увидеть количество кликов за последние 2 часа, день, неделю, 30 дней или все время (детальнее см. в разделе [короткие ссылки](how-to-shorten-url)). 
...
Подробнее о создании Форм вы можете узнать в разделе [“Формы”](how-to-create-form).  
