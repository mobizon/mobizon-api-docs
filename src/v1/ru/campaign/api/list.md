...
`criteria[from]`           | string  | Поиск по [подписи (альфаимени) отправителя](other#glossary-sender-id). <br>Поиск осуществляется по *подписи отправителя*, которая была использована в кампании.
...
Сортировка по имени кампании по возрастанию – sort[name]: ASC.

Сортировка по подписи отправителя по убыванию – sort[from]: DESC.
...
Содержит массив из двух полей
 ...
 Поле            | Тип     | Описание
-----------------|---------|-----------
`items`          | array   | Список найденных кампаний. <br>Описание полей кампании смотрите в описании метода [campaign/getInfo](../../api-docs/campaign#GetInfo).
