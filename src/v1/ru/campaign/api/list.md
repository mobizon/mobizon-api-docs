...
`criteria[from]`           | string  | Поиск по [подписи отправителя](other#glossary-sender-id).<br>Поиск осуществляется по *подписи отправителя*, которая была использована в кампании.
