...
Данный метод позволяет получить основные и статистические данные кампании по ее [ID](/ru/help/api-docs/other#glossary-id).
...
`isDeleted`                | integer | Флаг, который означает, что кампания удалена:<br>**0** – кампания доступна;<br>**1**– кампания удалена.
 ...
 `creationWay`             | integer | Способ создания кампании:<br>**1** – с помощью Интернет-браузера;<br>**5** – [функциональная (служебная) кампания](/ru/help/api-docs/other#glossary-functional-campaign).
