...
После создания кампании в нее необходимо добавить получателей, а затем отправить.
...
`data[trackShortLinkRecipients]`| integer |  [Функция отслеживания получателей](other#glossary-recipienttracking).<br>Доступна к использованию только если в тексте сообщения (в поле `data[text]`) есть [короткие ссылки](other#glossary-shortlink), созданные в [нашем сервисе](../../url-shortener/how-to-shorten-url).<br>`0` – не использовать функцию (установлено по умолчанию);<br>`1` – использовать функцию.
