...
Данный метод позволяет создать новую [SMS-кампанию](other#glossary-sms-campaign). 
После создания кампании в нее можно [добавить получателей](#addRecipients), а затем [отправить](#send).
